//! This widget is a kind of merge between of the original `Button` and `MouseArea`
//! widgets from [`iced`].
...
pub struct ActionArea<'a, Message, Theme = iced_core::Theme, Renderer = iced_widget::Renderer>
where
...
impl<'a, Message, Theme, Renderer> ActionArea<'a, Message, Theme, Renderer>
where
    Renderer: iced_core::Renderer,
    Theme: Catalog,
{
    /// Creates a new [`ActionArea`] with the given content.
    ...
    /// Sets the width of the [`ActionArea`].
    pub fn width(mut self, width: impl Into<Length>) -> Self {
        self.width = width.into();
        self
    }

    /// Sets the height of the [`ActionArea`].
    pub fn height(mut self, height: impl Into<Length>) -> Self {
        self.height = height.into();
        self
    }

    /// Sets the [`Padding`] of the [`ActionArea`].
    pub fn padding<P: Into<Padding>>(mut self, padding: P) -> Self {
        self.padding = padding.into();
        self
    }

    /// Sets the message that will be produced when the [`ActionArea`] is pressed.
    ///
    /// Unless `on_press` is called, the [`ActionArea`] will be disabled.
    ...
    /// Sets the message that will be produced when the [`ActionArea`] is pressed.
    ///
    /// This is analogous to [`ActionArea::on_press`], but using a closure to produce
    /// the message.
    ///
    /// This closure will only be called when the [`ActionArea`] is actually pressed and,
    ...
    /// if `Some`.
    ///
    /// If `None`, the [`ActionArea`] will be disabled.
    pub fn on_press_maybe(mut self, on_press: Option<Message>) -> Self {
        self.on_press = on_press.map(OnPress::Direct);
        self
    }

    /// Sets whether the contents of the [`ActionArea`] should be clipped on
    /// overflow.
    ...
    /// Sets the style of the [`ActionArea`].
    #[must_use]
    ...
    /// The [`mouse::Interaction`] to use when hovering the button.
    #[must_use]
    ...
    /// Sets the style class of the [`ActionArea`].
...
impl<'a, Message, Theme, Renderer> Widget<Message, Theme, Renderer>
    for ActionArea<'a, Message, Theme, Renderer>
where
    Message: 'a + Clone,
...
impl<'a, Message, Theme, Renderer> From<ActionArea<'a, Message, Theme, Renderer>>
...
{
    fn from(button: ActionArea<'a, Message, Theme, Renderer>) -> Self {
        Self::new(button)
    }
}

/// The default [`Padding`] of a [`ActionArea`].
...
/// The possible status of a [`ActionArea`].
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Status {
    /// The [`ActionArea`] can be pressed.
    Active,
    /// The [`ActionArea`] can be pressed and it is being hovered.
    Hovered,
    /// The [`ActionArea`] is being pressed.
    Pressed,
    /// The [`ActionArea`] cannot be pressed.
    Disabled,
}

/// The style of a button.
///
/// If not specified with [`ActionArea::style`]
...
/// The theme catalog of a [`ActionArea`].
///
/// All themes that can be used with [`ActionArea`]
...
/// ```
///
/// Although, in order to use [`ActionArea::style`]
...
/// A styling function for a [`ActionArea`].
...
pub fn styled(pair: palette::Pair) -> Style {
    Style {
